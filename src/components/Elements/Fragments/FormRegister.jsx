...
const FormRegister = () => {
  return (
    ...
    <div className=' items-center justify-center m-auto gap-6 grid rounded-xl my-[15vh]  pb-7'>
      <h1 className="text-center pointer-events-none text-slate-100 text-4xl font-bold">Register</h1>
      <h1 className="text-start pointer-events-none text-slate-300 mt-5 "><i> Please create your account </i></h1>
